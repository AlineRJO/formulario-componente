       ...
       let obj = new userModel();
        ...
        if (data.controls.state.errors) {
            if (data.controls.state.errors.required) {
                ...
                obj.v_state = "Campo UF deve possuir pelo menos 2 caracteres.";
        ...
        if (data.controls.numberComercial.errors) {
            if (data.controls.numberComercial.errors.required) {
                ...
                obj.v_numberComercial = "Este campo deve possuir pelo menos 10 caracteres.";
            } else if (data.controls.numberComercial.errors.maxlength) {
                obj.v_numberComercial = "Este campo não deve possuir mais que 20 caracteres.";
            }
            obj.valid = true;
        }
        if (data.controls.celPhone.errors) {
            if (data.controls.celPhone.errors.minlength) {
                obj.v_celPhone = "Este campo deve possuir pelo menos 10 caracteres.";
            } else if (data.controls.celPhone.errors.maxlength) {
                obj.v_celPhone = "Este campo não deve possuir mais que 20 caracteres.";
            }
            obj.valid = true;
        }
